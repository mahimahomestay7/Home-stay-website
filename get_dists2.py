...
homestay_coords = "75.987611,12.435917"

places = [
    "Namdroling Golden Temple", "Fish Lake 2nd Camp Bylakuppe", "Kaveri Nisargadhama",
    "Nisargadhama Bird Park", "Coorg Hanging Bridge", "Abbey Falls", "Raja's Seat",
    "Dubare Elephant Camp", "Mandalpatti Peak", "Talakaveri", "Iruppu Falls",
    "Madikeri Fort", "Mallalli Falls", "Chiklihole Reservoir", "Harangi Dam",
    "Honnamana Kere Lake", "Omkareswara Temple", "Kotebetta Peak", "Nalknad Aramane Palace",
    "Nehru Mantap", "Padi Iggutappa Temple", "Somwarpet", "Suntikoppa", "Tadiandamol Trek"
]
